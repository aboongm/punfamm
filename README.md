# PUNFAMM Project and Organization Overview

The purpose of this project is to develop an online news app that will deliver real-time news to its target audience, similar to the New York Times. The app will offer a modern and user-friendly interface, providing users with easy access to current news articles, videos, and photos from a variety of sources.

The target audience for this app will be individuals who are interested in staying up-to-date on the latest news and current events. This includes people who are looking for a convenient and accessible way to access news on the go, without having to navigate multiple websites or apps.
...
We are very happy to have you! PUNFAMM is committed to welcoming new contributors of all skill levels.

Issues on the issue board https://github.com/aboongm/punfamm/issues. An issue can be claimed by commenting on it.
...
The online news app will include the following key features and functionalities:
- A user-friendly interface that makes it easy to browse and search for news articles, videos, and photos.
- A customizable home page that allows users to personalize the news they receive based on their interests and preferences.
- A section for breaking news, which will provide real-time updates on the latest events.
- Integration with social media platforms, allowing users to share articles and updates with friends and followers.
- A search function that makes it easy for users to find articles and news stories related to specific topics or keywords.
- Push notifications for breaking news and other important updates.
- Access to a wide range of news sources, including both local and international outlets.
...
1. `git clone https://github.com/aboongm/punfamm.git` clone the repo to your local machine.  
2. You can [create a fork on GitHub](https://docs.github.com/en/get-started/quickstart/fork-a-repo) and make a pull request from the fork.  
...
...check out the instructions on [installing google-chrome and chromedriver for WSL Ubuntu](https://github.com/aboongm/punfamm/blob/main/doc/WSL_SETUP.md#google-chrome).
...
### Platform Specific Installation Instructions
 ...
 - Windows(Help Wanted)
 - [Windows Subsystem for Linux(WSL)](https://github.com/aboongm/punfamm/main/doc/WSL_SETUP.md)
...
- user1@example.com    view site as a volunteer
- reporter1@example.com   view site as a supervisor
- editor1@example.com   view site as an admin
- editor2-1@example.com view site as admin from a different org
...
# Other Documentation
Check out [the wiki](https://github.com/aboongm/punfamm/wiki)
